...
/**
 ...
 context      A new bitmap content created by layer.
 size         The content size (typically same as layer's bound size).
...
/**
 ...
 layer  The layer.
 finished  If the draw process is cancelled, it's `NO`, otherwise it's `YES`;
 */
